...
void generic_function2(void* gen_var2){
    printf("gen function 2\n");
    int x_flagsingle_x=0;
    L1_structure2* L1_structure = malloc(sizeof(L1_structure2));
...
void caller(void* arg){
    int x = (int)arg;
    if(x ==1)return generic_function0((void*)x);
...
int main()
{
    ...
    estrutura2=malloc(CORE_NUMBER*sizeof(L1_structure2));
